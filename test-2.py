    ...
    for match in matchlist:
        if match['class'][0] == "matchListDateBox":
            ...
            try:
                ...
                matchd['matchid'] = match.find("div", {"class": "matchActionCell"}).find("a").get(
                    'href')  # What a fucking mess lmao
...
def get_results():
    ...
    for result in resultslist:
        if result['class'][0] == "matchListDateBox":
            ...
            resultd['matchid'] = result.find("div", {"class": "matchActionCell"}).find("a").get(
                'href')  # What a fucking mess lmao
...
if __name__ == "__main__":
    ...
    # pp.pprint(get_team_info(7187))
    # pp.pprint(get_players(7187))
